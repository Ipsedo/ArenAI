...
- In this repo the `.pre-commit-config.yaml` for the C++ code lives in the parent `ArenAI/` directory; the Python tooling has its own under `arenai_agent/python/`. Pick the one matching the directory you're bootstrapping.
