...
Tetra::Tetra(AAssetManager *mgr, glm::vec3 pos, glm::vec3 scale,
    ...
    : Poly(
          ...
          Poly::makeModel(mgr, "obj/tetra.obj"), pos, scale, rotMat, mass,
          true) {}

Tetra::Tetra(DiffuseModel *modelVBO, glm::vec3 pos, glm::vec3 scale,
             glm::mat4 rotMat, float mass)
    : Poly(
          [](glm::vec3 scale) {
