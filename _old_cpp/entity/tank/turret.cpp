...
NormalMapModel *makeTurretModel(AAssetManager *mgr) {
  return new NormalMapModel(
    mgr, "obj/tank_turret.obj", "textures/turret_tex.png", "textures/199_norm.png");
}
...
Turret::Turret(AAssetManager *mgr, btDynamicsWorld *world, Base *chassis, btVector3 chassisPos)
    : Poly(
      ...
      makeTurretModel(mgr), btVector3ToVec3(chassisPos + turretRelPos), turretScale,
      glm::mat4(1.0f), turretMass, true),
