...
std::string diffuse_fs =
    ...
    "    diffuse = diffuse * (1.0 / (1.0 + (u_distance_coef * distance * "
    "distance)));\n"
...
void DiffuseModel::bind() {
  ...
  mDistanceCoefHandle =
      (GLuint)glGetUniformLocation(mProgram, "u_distance_coef");
