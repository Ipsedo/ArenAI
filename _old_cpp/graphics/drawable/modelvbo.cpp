...
TransparentModelVBO::TransparentModelVBO(const string &obj_file_text, float r,
                                         float g, float b, float a)
    : ModelVBO(obj_file_text, r, g, b, a) {}

TransparentModelVBO::TransparentModelVBO(const string &obj_file_text)
    : ModelVBO(obj_file_text) {}
