...
Level1::Level1()
    : Level(), isInit(false), cibles(vector<Cible *>()),
...
void Level1::init(bool isVR, AAssetManager *mgr, btDynamicsWorld *world) {
  ...
  SupportCible *supportCible1 =
      new SupportCible(mgr, glm::vec3(-28.f, 15.f, 40.f));
  ...
  SupportCible *supportCible2 =
      new SupportCible(mgr, glm::vec3(-77.f, 15.f, 150.f));
  ...
  SupportCible *supportCible3 =
      new SupportCible(mgr, glm::vec3(73.f, 15.f, 40.f));
