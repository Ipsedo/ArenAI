...
Java_com_samuelberrien_phyvr_controls_GamePad_control(
    JNIEnv *env, jobject instance, jlong levelPtr, jfloat direction,
...
Java_com_samuelberrien_phyvr_controls_GamePad_vibrate(JNIEnv *env, jobject thiz,
                                                      jlong level_ptr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_samuelberrien_phyvr_controls_GamePad_control2(
...
extern "C" JNIEXPORT void JNICALL
Java_com_samuelberrien_phyvr_controls_UI_control(
    JNIEnv *env, jobject instance, jlong levelPtr, jfloat direction,
    jfloat speed, jboolean brake, jfloat turretDir, jfloat turretUp,
    jboolean respawn, jboolean fire) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_samuelberrien_phyvr_controls_UI_vibrate(JNIEnv *env, jobject thiz,
                                                 jlong level_ptr) {
  vector<Controls *> ctrl = ((Level *)level_ptr)->getControls();
