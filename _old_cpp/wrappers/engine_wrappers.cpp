...
Java_com_samuelberrien_phyvr_MainWrappers_makeEngine(JNIEnv *env,
                                                     jobject instance,
                                                     jlong levelPtr,
                                                     jobject manager) {
...
Java_com_samuelberrien_phyvr_MainWrappers_updateEngine(JNIEnv *env,
                                                       jobject instance,
                                                       jlong enginePtr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_samuelberrien_phyvr_MainWrappers_freeEngine(JNIEnv *env,
                                                     jobject instance,
                                                     jlong enginePtr) {
