...
Java_com_samuelberrien_phyvr_MainWrappers_makeLevel(JNIEnv *env,
                                                    jobject instance,
                                                    jint levelId) {
  switch (int(levelId)) {
  case 0:
...
Java_com_samuelberrien_phyvr_MainWrappers_initLevel(
    JNIEnv *env, jobject instance, jobject manager, jboolean isVR,
    jlong levelPtr, jlong enginePtr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_samuelberrien_phyvr_MainWrappers_freeLevel(JNIEnv *env,
                                                    jobject instance,
                                                    jlong levelPtr) {
