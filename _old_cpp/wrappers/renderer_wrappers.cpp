...
extern "C" JNIEXPORT jlong JNICALL Java_com_samuelberrien_phyvr_MainWrappers_makeRenderer(
    JNIEnv *env, jobject instance, jlong levelPtr) {
...
extern "C" JNIEXPORT void JNICALL Java_com_samuelberrien_phyvr_MainWrappers_willDrawRenderer(
    JNIEnv *env, jobject instance, jlong rendererPtr, jfloatArray mHeadView_, jboolean VR) {
...
extern "C" JNIEXPORT void JNICALL Java_com_samuelberrien_phyvr_MainWrappers_drawRenderer(
    JNIEnv *env, jobject instance, jlong rendererPtr, jfloatArray mEyeProjectionMatrix_,
    jfloatArray mEyeViewMatrix_, jfloatArray myLighPosInEyeSpace_, jfloatArray mCameraPos_) {
    ...
    Renderer *renderer = (Renderer *) rendererPtr;
    renderer->draw(
        glm::make_mat4(eyeProjectionMatrix), glm::make_mat4(eyeViewMatrix),
        glm::make_vec3(lighPosInEyeSpace), glm::make_vec3(cameraPos));
...
extern "C" JNIEXPORT void JNICALL Java_com_samuelberrien_phyvr_MainWrappers_freeRenderer(
    JNIEnv *env, jobject instance, jlong rendererPtr) {
