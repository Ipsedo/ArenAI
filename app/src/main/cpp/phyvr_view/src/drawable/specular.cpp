...
Specular::Specular(const std::shared_ptr<AbstractFileReader> &file_reader,
  ...
  program = Program::Builder(file_reader, "shaders/specular_vs.glsl",
...
void Specular::draw(glm::mat4 mvp_matrix, glm::mat4 mv_matrix,
  ...
  program->attrib("a_position", "vertices_normals_buffer", POSITION_SIZE,
                  STRIDE, 0);
  program->attrib("a_normal", "vertices_normals_buffer", NORMAL_SIZE, STRIDE,
