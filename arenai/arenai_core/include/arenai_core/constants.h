...
// (position + velocity + force + angle_quaternion + angle_velocity + torque) * (6 * wheel + chassis + turret + canon) - chassis_pos
#define ENEMY_PROPRIOCEPTION_SIZE ((3 + 3 + 3 + 4 + 3 + 3) * (6 + 3) - 3)
