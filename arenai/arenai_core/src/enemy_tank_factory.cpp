...
EnemyTankFactory::EnemyTankFactory(
    ...
    : TankFactory(file_reader, tank_prefix_name, chassis_pos, wanted_frame_frequency),
      ...
      curr_frame_upside_down(0), is_dead_already_triggered(false), distance_scale(100.f),
      optimal_distance(75.f), angle_scale(static_cast<float>(M_PI) / 4.f), has_touch(false),
