...
SacAgent::SacAgent(
    ...
    : actor(std::make_shared<Actor>(
      ...
      gamma(gamma),
      continuous_target_entropy(truncated_normal_target_entropy(nb_continuous_actions, 0.2f)),
      discrete_target_entropy(multinomial_target_entropy(nb_discrete_actions, 0.25f)) {
