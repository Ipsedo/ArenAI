...
int main(const int argc, char **argv) {
    ...
    parser.add_argument("--group_norm_nums")
        .default_value<group_norm_nums>({{2, 4, 8, 16, 32, 32, 32}})
    ...
    parser.add_argument("--actor_hidden_size").scan<'i', int>().default_value(2560);
    parser.add_argument("--critic_hidden_size").scan<'i', int>().default_value(2560);
