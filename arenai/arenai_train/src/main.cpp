...
int main(const int argc, char **argv) {
    ...
    parser.add_argument("--initial_alpha_continuous").scan<'g', float>().default_value(0.01f);
    parser.add_argument("--initial_alpha_discrete").scan<'g', float>().default_value(0.01f);
