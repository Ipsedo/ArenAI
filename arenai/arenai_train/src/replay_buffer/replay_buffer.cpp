...
namespace arenai::train {
    ...
    void ReplayBuffer::add(const TorchInputStep &step) {
        ...
        store_main_reward_[idx].copy_(reward);
        store_potential_reward_[idx].copy_(potential);
    ...
    TorchStep ReplayBuffer::transform_at_sample(const TorchInputStep &batch_steps) const {
        return {
