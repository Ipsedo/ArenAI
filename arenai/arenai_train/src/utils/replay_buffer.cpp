...
TorchStep ReplayBuffer::sample(int batch_size, torch::Device device) {
    ...
    std::vector<torch::Tensor> states_vision, states_proprioception, cont_actions, disc_actions,
        rewards, dones, next_states_vision, next_states_proprioception;
