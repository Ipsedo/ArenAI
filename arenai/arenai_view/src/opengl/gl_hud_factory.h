...
#ifndef ARENAI_GL_HUD_FACTORY_H
#define ARENAI_GL_HUD_FACTORY_H

#include <arenai_view/hud_factory.h>

namespace arenai::view {

    class GlHudFactory final : public AbstractHudFactory {
    public:
