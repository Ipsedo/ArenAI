...
namespace arenai::agent {
    ...
    std::vector<CliField<PpoHyperParams>> ppo_cli_fields() {
        return {
            ...
            {.name = "--continuous_entropy_factor_init",
             .member = &PpoHyperParams::continuous_entropy_factor_init},
            {.name = "--continuous_entropy_factor_final",
             .member = &PpoHyperParams::continuous_entropy_factor_final},
