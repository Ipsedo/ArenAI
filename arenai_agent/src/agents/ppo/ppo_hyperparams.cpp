...
namespace arenai::agent {
    ...
    std::vector<CliField<PpoHyperParams>> ppo_cli_fields() {
        return {
            ...
            {.name = "--continuous_target_entropy_init",
             .member = &PpoHyperParams::continuous_target_entropy_init},
            {.name = "--continuous_target_entropy_final",
             .member = &PpoHyperParams::continuous_target_entropy_final},
            {.name = "--target_entropy_warmup_steps",
             .member = &PpoHyperParams::target_entropy_warmup_steps},
            {.name = "--discrete_entropy_factor_init",
             .member = &PpoHyperParams::discrete_entropy_factor_init},
            {.name = "--discrete_entropy_factor_final",
             .member = &PpoHyperParams::discrete_entropy_factor_final},
