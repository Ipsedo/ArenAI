...
namespace arenai::agent {
    ...
    std::vector<CliField<PpoHyperParams>> ppo_cli_fields() {
        return {
            ...
            {"--initial_sigma", &PpoHyperParams::initial_sigma},
            {"--initial_fire_proba", &PpoHyperParams::initial_fire_proba},
            ...
            {"--continuous_entropy_coefficient", &PpoHyperParams::continuous_entropy_coefficient},
            {"--discrete_entropy_coefficient", &PpoHyperParams::discrete_entropy_coefficient},
