    ...
    std::vector<CliField<SacHyperParams>> sac_cli_fields() {
        return {
            ...
            {.name = "--continuous_target_entropy_init",
             .member = &SacHyperParams::continuous_target_entropy_init},
            {.name = "--continuous_target_entropy_final",
             .member = &SacHyperParams::continuous_target_entropy_final},
            {.name = "--discrete_target_factor_init",
             .member = &SacHyperParams::discrete_target_factor_init},
            {.name = "--discrete_target_factor_final",
             .member = &SacHyperParams::discrete_target_factor_final},
            {.name = "--target_entropy_warmup_steps",
             .member = &SacHyperParams::target_entropy_warmup_steps},
