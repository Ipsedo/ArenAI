...
namespace arenai::agent {
    ...
    void init_kappa_output_weights(torch::nn::Module &module, float init_kappa);
    void init_discrete_output_weights(torch::nn::Module &module, float initial_fire_probability);
