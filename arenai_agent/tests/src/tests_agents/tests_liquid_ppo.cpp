...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        LiquidPpoTestConfig{8, 8, 10, 4, 2}, LiquidPpoTestConfig{8, 8, 5, 2, 2},
        LiquidPpoTestConfig{16, 16, 20, 6, 2}, LiquidPpoTestConfig{8, 12, 10, 4, 2}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        LiquidPpoTestConfig{8, 8, 10, 4, 2}, LiquidPpoTestConfig{8, 8, 5, 2, 2},
        LiquidPpoTestConfig{16, 16, 20, 6, 2}));
