...
#ifndef ARENAI_DESKTOP_GUI_RML_RETICLE_H
#define ARENAI_DESKTOP_GUI_RML_RETICLE_H

#include <RmlUi/Core.h>

namespace arenai::desktop::gui {

    class ReticleDecorator final : public Rml::Decorator {
    public:
        ReticleDecorator(Rml::NumericValue thickness, Rml::NumericValue gap);
    ...
    class ReticleDecoratorInstancer final : public Rml::DecoratorInstancer {
    public:
        ReticleDecoratorInstancer();
...
#endif// ARENAI_DESKTOP_GUI_RML_RETICLE_H
